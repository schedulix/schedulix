...
ALTER TABLE EXIT_STATE ADD COLUMN IS_DISABLED integer NOT NULL WITH DEFAULT;\g
...
ALTER TABLE SCHEDULING_HIERARCHY ADD COLUMN ENABLE_CONDITION varchar(2048);\g
ALTER TABLE SCHEDULING_HIERARCHY ADD COLUMN ENABLE_MODE integer NOT NULL WITH DEFAULT;\g
