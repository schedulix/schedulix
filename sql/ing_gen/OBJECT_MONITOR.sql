...
CREATE TABLE OBJECT_MONITOR (
    ...
    , WATCH_SE_ID                    decimal(20)     WITH NULL
    , DELETE_AMOUNT                  integer         WITH NULL
    , DELETE_BASE                    integer         WITH NULL
    , EVENT_DELETE_AMOUNT            integer         WITH NULL
    , EVENT_DELETE_BASE              integer         WITH NULL
...
ON OBJECT_MONITOR(ID) WITH STRUCTURE = BTREE;\g
