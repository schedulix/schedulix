...
CREATE TABLE NICE_PROFILE (
    ...
    , ACTIVE_TS                      decimal(20)     WITH NULL
...
ON NICE_PROFILE(ID) WITH STRUCTURE = BTREE;\g
...
ALTER TABLE SUBMITTED_ENTITY ADD COLUMN RAW_PRIORITY integer NOT NULL WITH DEFAULT;\g
ALTER TABLE SUBMITTED_ENTITY ADD COLUMN NP_NICE integer NOT NULL WITH DEFAULT;\g
ALTER TABLE SUBMITTED_ENTITY ADD COLUMN IDLE_TS integer;\g
ALTER TABLE SUBMITTED_ENTITY ADD COLUMN IDLE_TIME integer;\g
ALTER TABLE SUBMITTED_ENTITY ADD COLUMN STATISTIC_TS integer;\g
ALTER TABLE SUBMITTED_ENTITY ADD COLUMN DEPENDENCY_WAIT_TIME integer;\g
ALTER TABLE SUBMITTED_ENTITY ADD COLUMN SUSPEND_TIME integer;\g
ALTER TABLE SUBMITTED_ENTITY ADD COLUMN SYNC_TIME integer;\g
ALTER TABLE SUBMITTED_ENTITY ADD COLUMN RESOURCE_TIME integer;\g
ALTER TABLE SUBMITTED_ENTITY ADD COLUMN JOBSERVER_TIME integer;\g
ALTER TABLE SUBMITTED_ENTITY ADD COLUMN RESTARTABLE_TIME integer;\g
ALTER TABLE SUBMITTED_ENTITY ADD COLUMN CHILD_WAIT_TIME integer;\g
ALTER TABLE SUBMITTED_ENTITY ADD COLUMN OP_SUSRES_TS decimal(20);\g
ALTER TABLE SUBMITTED_ENTITY ADD COLUMN NPE_ID decimal(20);\g
...
UPDATE SUBMITTED_ENTITY SET RAW_PRIORITY = PRIORITY;\g
commit;\g
