...
SELECT
    ...
    , '01-JAN-1970 00:00:00 GMT' + date(char(decimal((CHANGE_TS- decimal(CHANGE_TS/1125899906842624, 18, 0)*1125899906842624)/1000, 18, 0)) + ' secs') AS CHANGE_TS
  FROM RESSOURCE;\g
ALTER TABLE RESOURCE_ALLOCATION ADD COLUMN STICKY_NAME varchar(64);\g
ALTER TABLE RESOURCE_ALLOCATION ADD COLUMN STICKY_PARENT decimal(20);\g
...
ALTER TABLE RESOURCE_REQUIREMENT ADD COLUMN STICKY_NAME varchar(64);\g
ALTER TABLE RESOURCE_REQUIREMENT ADD COLUMN STICKY_PARENT decimal(20);\g
...
ALTER TABLE SCOPE ADD COLUMN SALT varchar(64);\g
ALTER TABLE SCOPE ADD COLUMN METHOD integer NOT NULL WITH DEFAULT;\g
...
ALTER TABLE USERS ADD COLUMN SALT varchar(64);\g
ALTER TABLE USERS ADD COLUMN METHOD integer NOT NULL WITH DEFAULT;\g
...
CREATE TABLE SME2LOAD (ID DECIMAL(20) NOT NULL);\g
CREATE INDEX SME2LOAD_IDX ON SME2LOAD (ID);\g
CREATE INDEX SME_IDX ON SUBMITTED_ENTITY (MASTER_ID, ID, STATE, FINAL_TS);\g
CREATE INDEX KILL_JOB_IDX ON KILL_JOB (SME_ID);\g
CREATE INDEX AUDIT_TRAIL_IDX ON AUDIT_TRAIL (OBJECT_ID);\g
CREATE INDEX ENTITY_VARIABLE_IDX ON ENTITY_VARIABLE (SME_ID);\g
CREATE INDEX DEPENDENCY_INSTANCE_IDX ON DEPENDENCY_INSTANCE (DEPENDENT_ID);\g
CREATE INDEX HIERARCHY_INSTANCE_IDX ON HIERARCHY_INSTANCE (CHILD_ID);\g
...
UPDATE RESOURCE_ALLOCATION
 ...
 WHERE IS_STICKY = 1
   AND SME_ID < 0;\g
ALTER TABLE SCOPE ALTER PASSWD VARCHAR(64);\g
