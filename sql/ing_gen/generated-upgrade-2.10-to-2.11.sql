...
ALTER TABLE SCHEDULING_ENTITY ADD COLUMN CANCEL_LEAD_FLAG integer NOT NULL WITH DEFAULT;\g
ALTER TABLE SCHEDULING_ENTITY ADD COLUMN CANCEL_APPROVAL integer NOT NULL WITH DEFAULT;\g
ALTER TABLE SCHEDULING_ENTITY ADD COLUMN RERUN_LEAD_FLAG integer NOT NULL WITH DEFAULT;\g
ALTER TABLE SCHEDULING_ENTITY ADD COLUMN RERUN_APPROVAL integer NOT NULL WITH DEFAULT;\g
ALTER TABLE SCHEDULING_ENTITY ADD COLUMN ENABLE_LEAD_FLAG integer NOT NULL WITH DEFAULT;\g
ALTER TABLE SCHEDULING_ENTITY ADD COLUMN ENABLE_APPROVAL integer NOT NULL WITH DEFAULT;\g
ALTER TABLE SCHEDULING_ENTITY ADD COLUMN SET_STATE_LEAD_FLAG integer NOT NULL WITH DEFAULT;\g
ALTER TABLE SCHEDULING_ENTITY ADD COLUMN SET_STATE_APPROVAL integer NOT NULL WITH DEFAULT;\g
ALTER TABLE SCHEDULING_ENTITY ADD COLUMN IGN_DEP_LEAD_FLAG integer NOT NULL WITH DEFAULT;\g
ALTER TABLE SCHEDULING_ENTITY ADD COLUMN IGN_DEP_APPROVAL integer NOT NULL WITH DEFAULT;\g
ALTER TABLE SCHEDULING_ENTITY ADD COLUMN IGN_RSS_LEAD_FLAG integer NOT NULL WITH DEFAULT;\g
ALTER TABLE SCHEDULING_ENTITY ADD COLUMN IGN_RSS_APPROVAL integer NOT NULL WITH DEFAULT;\g
ALTER TABLE SCHEDULING_ENTITY ADD COLUMN CLONE_LEAD_FLAG integer NOT NULL WITH DEFAULT;\g
ALTER TABLE SCHEDULING_ENTITY ADD COLUMN CLONE_APPROVAL integer NOT NULL WITH DEFAULT;\g
ALTER TABLE SCHEDULING_ENTITY ADD COLUMN SUSPEND_LEAD_FLAG integer NOT NULL WITH DEFAULT;\g
ALTER TABLE SCHEDULING_ENTITY ADD COLUMN SUSPEND_APPROVAL integer NOT NULL WITH DEFAULT;\g
ALTER TABLE SCHEDULING_ENTITY ADD COLUMN CLR_WARN_LEAD_FLAG integer NOT NULL WITH DEFAULT;\g
ALTER TABLE SCHEDULING_ENTITY ADD COLUMN CLR_WARN_APPROVAL integer NOT NULL WITH DEFAULT;\g
ALTER TABLE SCHEDULING_ENTITY ADD COLUMN PRIORITY_LEAD_FLAG integer NOT NULL WITH DEFAULT;\g
ALTER TABLE SCHEDULING_ENTITY ADD COLUMN PRIORITY_APPROVAL integer NOT NULL WITH DEFAULT;\g
ALTER TABLE SCHEDULING_ENTITY ADD COLUMN EDIT_PARM_LEAD_FLAG integer NOT NULL WITH DEFAULT;\g
ALTER TABLE SCHEDULING_ENTITY ADD COLUMN EDIT_PARM_APPROVAL integer NOT NULL WITH DEFAULT;\g
ALTER TABLE SCHEDULING_ENTITY ADD COLUMN KILL_LEAD_FLAG integer NOT NULL WITH DEFAULT;\g
ALTER TABLE SCHEDULING_ENTITY ADD COLUMN KILL_APPROVAL integer NOT NULL WITH DEFAULT;\g
ALTER TABLE SCHEDULING_ENTITY ADD COLUMN SET_JOB_STATE_LEAD_FLAG integer NOT NULL WITH DEFAULT;\g
ALTER TABLE SCHEDULING_ENTITY ADD COLUMN SET_JOB_STATE_APPROVAL integer NOT NULL WITH DEFAULT;\g
...
SELECT
    ...
    , '01-JAN-1970 00:00:00 GMT' + date(char(decimal((CHANGE_TS- decimal(CHANGE_TS/1125899906842624, 18, 0)*1125899906842624)/1000, 18, 0)) + ' secs') AS CHANGE_TS
  FROM SME_COUNTER;\g
ALTER TABLE SUBMITTED_ENTITY ADD COLUMN APPROVAL_MODE integer NOT NULL WITH DEFAULT;\g
...
INSERT INTO USERS (ID, NAME,           PASSWD,                                SALT, METHOD, IS_ENABLED, DEFAULT_G_ID, CONNECTION_TYPE, DELETE_VERSION, CREATOR_U_ID, CREATE_TS, CHANGER_U_ID, CHANGE_TS)
                  VALUES     (3, 'FE_PROPERTIES', 'xxxxxxxx xxxxxxxx xxxxxxxx xxxxxxxx',        null, 0,      0,          80,           0,               0,              0,            0,         0,            0);\g
INSERT INTO MEMBER (ID, G_ID, U_ID, CREATOR_U_ID, CREATE_TS, CHANGER_U_ID, CHANGE_TS)
                  VALUES             (94, 80,   3,    0,            0,         0,            0);;\g
ALTER TABLE REPOSITORY_LOCK ADD COLUMN IPS VARCHAR(256);\g
commit;\g
