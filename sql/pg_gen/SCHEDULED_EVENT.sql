...
SELECT
    ...
    , timestamp 'epoch' + cast(to_char(mod(LAST_START_TIME, 1125899906842624)/1000, '999999999999') as interval) AS LAST_START_TIME
    , timestamp 'epoch' + cast(to_char(mod(NEXT_START_TIME, 1125899906842624)/1000, '999999999999') as interval) AS NEXT_START_TIME
