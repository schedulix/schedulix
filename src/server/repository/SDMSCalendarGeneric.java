	...
	implements Cloneable
{
	...
	public final static String __version = "SDMSCalendarGeneric $Revision: 2.2 $ / @(#) $Id: generate.py,v 2.42.2.7 2013/04/17 12:40:29 ronald Exp $";
	...
	public	SDMSCalendarGeneric setScevId (SystemEnvironment env, Long p_scevId)
	throws SDMSException
	{
		if(scevId.equals(p_scevId)) return this;
	...
	public	SDMSCalendarGeneric setStarttime (SystemEnvironment env, Long p_starttime)
	throws SDMSException
	{
		if(starttime.equals(p_starttime)) return this;
		SDMSCalendarGeneric o;
		env.tx.beginSubTransaction(env);
		try {
			if (versions.id.longValue() < SystemEnvironment.SYSTEM_OBJECTS_BOUNDARY) {
	...
	SDMSCalendarGeneric setCreatorUId (SystemEnvironment env, Long p_creatorUId)
	throws SDMSException
	{
	...
	SDMSCalendarGeneric setCreateTs (SystemEnvironment env, Long p_createTs)
	throws SDMSException
	{
	...
	public	SDMSCalendarGeneric setChangerUId (SystemEnvironment env, Long p_changerUId)
	throws SDMSException
	{
		SDMSCalendarGeneric o;
		env.tx.beginSubTransaction(env);
	...
	SDMSCalendarGeneric setChangeTs (SystemEnvironment env, Long p_changeTs)
	throws SDMSException
	{
	...
	throws SDMSException
	{
		...
		try {
			...
			pInsert.setLong (2, scevId.longValue());
			pInsert.setLong (3, starttime.longValue());
			...
			throw new FatalException(new SDMSMessage(env, "01110181954", "Calendar: $1 $2", new Integer(sqle.getErrorCode()), sqle.getMessage()));
		}
	}
	...
	throws SDMSException
	{
		...
		try {
			...
			throw new FatalException(new SDMSMessage(env, "01110182002", "Calendar: $1 $2", new Integer(sqle.getErrorCode()), sqle.getMessage()));
		}
	}
	...
	throws SDMSException
	{
		...
		try {
			...
			pUpdate.setLong (1, scevId.longValue());
			pUpdate.setLong (2, starttime.longValue());
			...
			throw new FatalException(new SDMSMessage(env, "01110182006", "Calendar: $1 $2", new Integer(sqle.getErrorCode()), sqle.getMessage()));
		}
	}
