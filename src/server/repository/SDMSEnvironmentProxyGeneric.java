...
public class SDMSEnvironmentProxyGeneric extends SDMSProxy
{
	...
	protected SDMSEnvironmentProxyGeneric(SDMSObject p_object)
	{
		super(p_object);
	}

	protected static SDMSEnvironment getProxy (SystemEnvironment sysEnv, SDMSObject p_object)
	{
		int i = SDMSEnvironmentTable.table.tableIndex;
		SDMSProxy p = SDMSRepository.getProxy(i);
		if (p == null)
			p = new SDMSEnvironment (p_object);
		else {
			p.initProxy(p_object);
		}
		sysEnv.tx.addUsedProxy(i, p);
		return (SDMSEnvironment)p;
	}
	...
	{
		checkRead(env);
		return (((SDMSEnvironmentGeneric)(object)).getNeId (env));
	}
	...
	throws SDMSException
	{
		...
		touchMaster(env);
		((SDMSEnvironmentGeneric)(object)).setNeId (env, p_neId);
		return ;
	}
	...
	{
		checkRead(env);
		return (((SDMSEnvironmentGeneric)(object)).getNrId (env));
	}
	...
	throws SDMSException
	{
		...
		touchMaster(env);
		((SDMSEnvironmentGeneric)(object)).setNrId (env, p_nrId);
		return ;
	}
	...
	{
		checkRead(env);
		return (((SDMSEnvironmentGeneric)(object)).getCondition (env));
	}
	...
	{
		checkRead(env);
		return (((SDMSEnvironmentGeneric)(object)).getCreatorUId (env));
	}
	...
	throws SDMSException
	{
		...
		touchMaster(env);
		((SDMSEnvironmentGeneric)(object)).setCreatorUId (env, p_creatorUId);
		return ;
	}
	...
	{
		checkRead(env);
		return (((SDMSEnvironmentGeneric)(object)).getCreateTs (env));
	}
	...
	throws SDMSException
	{
		...
		touchMaster(env);
		((SDMSEnvironmentGeneric)(object)).setCreateTs (env, p_createTs);
		return ;
	}
	...
	{
		checkRead(env);
		return (((SDMSEnvironmentGeneric)(object)).getChangerUId (env));
	}
	...
	throws SDMSException
	{
		...
		touchMaster(env);
		((SDMSEnvironmentGeneric)(object)).setChangerUId (env, p_changerUId);
		return ;
	}
	protected SDMSEnvironment setChangerUIdNoCheck (SystemEnvironment env, Long p_changerUId)
	throws SDMSException
	{
		checkWrite(env);
		touchMaster(env);
	...
	{
		checkRead(env);
		return (((SDMSEnvironmentGeneric)(object)).getChangeTs (env));
	}
	...
	throws SDMSException
	{
		...
		touchMaster(env);
		((SDMSEnvironmentGeneric)(object)).setChangeTs (env, p_changeTs);
		return ;
	}
	protected SDMSEnvironment setChangeTsNoCheck (SystemEnvironment env, Long p_changeTs)
	throws SDMSException
	{
		checkWrite(env);
		touchMaster(env);
	...
	public SDMSEnvironment set_NeIdNrId (SystemEnvironment env, Long p_neId, Long p_nrId)
	throws SDMSException
	{
		checkRead(env);
		if(!checkPrivileges(env, SDMSPrivilege.EDIT))
		...
		touchMaster(env);
		((SDMSEnvironmentGeneric)(object)).set_NeIdNrId (env, p_neId, p_nrId);
		return (SDMSEnvironment)this;
	}
	...
	throws SDMSException
	{
		...
		gotIt = false;
		Long neId = getNeId(sysEnv);
		if (!gotIt)
			try {
				s.add(SDMSNamedEnvironmentTable.getObject(sysEnv, neId).getSortKey(sysEnv));
				gotIt = true;
	...
	throws SDMSException
	{
		...
		try {
			SDMSProxy o = t.get(env, getNeId(env));
	...
	throws SDMSException
	{
		...
		try {
			...
			SDMSProxy o = t.get(env, getNeId(env), version);
			long sp = o.getPrivileges(env, privilegeMask, false, checkGroups);
			if ((sp & SDMSPrivilege.EDIT) == SDMSPrivilege.EDIT) {
				sp |= SDMSPrivilege.CREATE | SDMSPrivilege.DROP | SDMSPrivilege.VIEW;
			}
	...
	{
		SDMSMessage m;
		m = new SDMSMessage(sysEnv, errno, "Insufficient privileges accessing Environment $1", getId(sysEnv));
		return m;
	}
	...
	throws SDMSException
	{
		...
		t = SystemEnvironment.repository.getTable(env, SDMSNamedEnvironmentTable.tableName);
		try {
			SDMSProxy p = t.get(env, getNeId(env));
			p.touch(env);
		} catch (NotFoundException nfe) {
		}
	}
	...
	public void print()
	{
		((SDMSEnvironmentGeneric) object).print();
	}
}
