...
public class SDMSNamedResourceTableGeneric extends SDMSTable
{
	...
	public final static String __version = "SDMSNamedResourceTableGeneric $Revision: 2.9 $ / @(#) $Id: generate.py,v 2.42.2.7 2013/04/17 12:40:29 ronald Exp $";
	...
	throws SDMSException
	{
		idx_name.put(env, ((SDMSNamedResourceGeneric) o).name, o);
		idx_ownerId.put(env, ((SDMSNamedResourceGeneric) o).ownerId, o);
		idx_parentId.put(env, ((SDMSNamedResourceGeneric) o).parentId, o);
		idx_rspId.put(env, ((SDMSNamedResourceGeneric) o).rspId, o);
		SDMSKey k;
		k = new SDMSKey();
