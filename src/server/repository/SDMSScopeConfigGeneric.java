	...
	implements Cloneable
{
	...
	throws SDMSException
	{
		...
		SDMSScopeConfigGeneric o = this;
		if (versions.id.longValue() < SystemEnvironment.SYSTEM_OBJECTS_BOUNDARY) {
			throw new CommonErrorException(
			        new SDMSMessage (env, "02112141636", "(ScopeConfig) Change of system object not allowed")
			);
		}
		if (o.versions.o_v == null || o.versions.o_v.size() == 0 || o.subTxId != env.tx.subTxId) o = (SDMSScopeConfigGeneric) change(env);
		if (p_value != null && p_value.length() > 256) {
			throw new CommonErrorException (
			        new SDMSMessage(env, "01112141510",
			                        "(ScopeConfig) Length of $1 exceeds maximum length $2", "value", "256")
	...
	throws SDMSException
	{
		...
		try {
			...
			myInsert.setString(2, key);
			myInsert.setString(3, value);
			myInsert.setLong (4, sId.longValue());
			...
			throw new SDMSSQLException(new SDMSMessage(env, "01110181954", "ScopeConfig: $1 $2", Integer.valueOf(sqle.getErrorCode()), sqle.getMessage()));
		}
	}
	...
	throws SDMSException
	{
		...
		try {
			...
			throw new SDMSSQLException(new SDMSMessage(env, "01110182002", "ScopeConfig: $1 $2", Integer.valueOf(sqle.getErrorCode()), sqle.getMessage()));
		}
	}
	...
	throws SDMSException
	{
		...
		try {
			...
			myUpdate.setString(1, key);
			myUpdate.setString(2, value);
			myUpdate.setLong (3, sId.longValue());
			...
			throw new SDMSSQLException(new SDMSMessage(env, "01110182006", "ScopeConfig: $1 $2", Integer.valueOf(sqle.getErrorCode()), sqle.getMessage()));
		}
	}
