...
public class SDMSIntervalHierarchyProxyGeneric extends SDMSProxy
{
	...
	protected SDMSIntervalHierarchyProxyGeneric(SDMSObject p_object)
	{
		super(p_object);
	}

	protected static SDMSIntervalHierarchy getProxy (SystemEnvironment sysEnv, SDMSObject p_object)
	{
		int i = SDMSIntervalHierarchyTable.table.tableIndex;
		SDMSProxy p = SDMSRepository.getProxy(i);
		if (p == null)
			p = new SDMSIntervalHierarchy (p_object);
		else {
			p.initProxy(p_object);
		}
		sysEnv.tx.addUsedProxy(i, p);
		return (SDMSIntervalHierarchy)p;
	}
	...
	{
		checkRead(env);
		return (((SDMSIntervalHierarchyGeneric)(object)).getChildId (env));
	}
	...
	throws SDMSException
	{
		...
		touchMaster(env);
		((SDMSIntervalHierarchyGeneric)(object)).setChildId (env, p_childId);
		return ;
	}
	...
	{
		checkRead(env);
		return (((SDMSIntervalHierarchyGeneric)(object)).getParentId (env));
	}
	...
	throws SDMSException
	{
		...
		touchMaster(env);
		((SDMSIntervalHierarchyGeneric)(object)).setParentId (env, p_parentId);
		return ;
	}
	...
	{
		checkRead(env);
		return (((SDMSIntervalHierarchyGeneric)(object)).getCreatorUId (env));
	}
	...
	throws SDMSException
	{
		...
		touchMaster(env);
		((SDMSIntervalHierarchyGeneric)(object)).setCreatorUId (env, p_creatorUId);
		return ;
	}
	...
	{
		checkRead(env);
		return (((SDMSIntervalHierarchyGeneric)(object)).getCreateTs (env));
	}
	...
	throws SDMSException
	{
		...
		touchMaster(env);
		((SDMSIntervalHierarchyGeneric)(object)).setCreateTs (env, p_createTs);
		return ;
	}
	...
	{
		checkRead(env);
		return (((SDMSIntervalHierarchyGeneric)(object)).getChangerUId (env));
	}
	...
	throws SDMSException
	{
		...
		touchMaster(env);
		((SDMSIntervalHierarchyGeneric)(object)).setChangerUId (env, p_changerUId);
		return ;
	}
	protected SDMSIntervalHierarchy setChangerUIdNoCheck (SystemEnvironment env, Long p_changerUId)
	throws SDMSException
	{
		checkWrite(env);
		touchMaster(env);
	...
	{
		checkRead(env);
		return (((SDMSIntervalHierarchyGeneric)(object)).getChangeTs (env));
	}
	...
	protected SDMSIntervalHierarchy setChangeTsNoCheck (SystemEnvironment env, Long p_changeTs)
	throws SDMSException
	{
		checkWrite(env);
		touchMaster(env);
	...
	{
		SDMSMessage m;
		m = new SDMSMessage(sysEnv, errno, "Insufficient privileges accessing IntervalHierarchy $1", getId(sysEnv));
		return m;
	}
	...
	public void print()
	{
		((SDMSIntervalHierarchyGeneric) object).print();
	}
}
