...
public class SDMSExitStateProfileProxyGeneric extends SDMSProxy
{

	public final static String __version = "SDMSExitStateProfileProxyGeneric $Revision: 2.4 $ / @(#) $Id: generate.py,v 2.42.2.7 2013/04/17 12:40:29 ronald Exp $";
	...
	{
		checkRead(env);
		return (((SDMSExitStateProfileGeneric)(object)).getName (env));
	}
	...
	throws SDMSException
	{
		...
		((SDMSExitStateProfileGeneric)(object)).setName (env, p_name);
		return ;
	}
	...
	{
		checkRead(env);
		return (((SDMSExitStateProfileGeneric)(object)).getDefaultEsmpId (env));
	}

	public void setDefaultEsmpId (SystemEnvironment env, Long p_defaultEsmpId)
	throws SDMSException
	{
		checkWrite(env);
		if(!checkPrivileges(env, SDMSPrivilege.EDIT))
		...
		((SDMSExitStateProfileGeneric)(object)).setDefaultEsmpId (env, p_defaultEsmpId);
		return ;
	}
	...
	{
		checkRead(env);
		return (((SDMSExitStateProfileGeneric)(object)).getIsValid (env));
	}

	public void setIsValid (SystemEnvironment env, Boolean p_isValid)
	throws SDMSException
	{
		checkWrite(env);
		if(!checkPrivileges(env, SDMSPrivilege.EDIT))
		...
		((SDMSExitStateProfileGeneric)(object)).setIsValid (env, p_isValid);
		return ;
	}
	...
	{
		checkRead(env);
		return (((SDMSExitStateProfileGeneric)(object)).getCreatorUId (env));
	}
	...
	throws SDMSException
	{
		...
		((SDMSExitStateProfileGeneric)(object)).setCreatorUId (env, p_creatorUId);
		return ;
	}
	...
	{
		checkRead(env);
		return (((SDMSExitStateProfileGeneric)(object)).getCreateTs (env));
	}
	...
	throws SDMSException
	{
		...
		((SDMSExitStateProfileGeneric)(object)).setCreateTs (env, p_createTs);
		return ;
	}
	...
	{
		checkRead(env);
		return (((SDMSExitStateProfileGeneric)(object)).getChangerUId (env));
	}
	...
	throws SDMSException
	{
		...
		((SDMSExitStateProfileGeneric)(object)).setChangerUId (env, p_changerUId);
		return ;
	}
	protected SDMSExitStateProfile setChangerUIdNoCheck (SystemEnvironment env, Long p_changerUId)
	throws SDMSException
	{
		checkWrite(env);
		((SDMSExitStateProfileGeneric)(object)).setChangerUId (env, p_changerUId);
		return (SDMSExitStateProfile)this;
	}
	public Long getChangeTs (SystemEnvironment env)
	throws SDMSException
	{
		checkRead(env);
		return (((SDMSExitStateProfileGeneric)(object)).getChangeTs (env));
	}
	...
	throws SDMSException
	{
		...
		((SDMSExitStateProfileGeneric)(object)).setChangeTs (env, p_changeTs);
		return ;
	}
	protected SDMSExitStateProfile setChangeTsNoCheck (SystemEnvironment env, Long p_changeTs)
	throws SDMSException
	{
		checkWrite(env);
		((SDMSExitStateProfileGeneric)(object)).setChangeTs (env, p_changeTs);
	...
	{
		SDMSMessage m;
		m = new SDMSMessage(sysEnv, errno, "Insufficient privileges accessing Exit State Profile $1", getName(sysEnv));
		return m;
	}
	...
	public void print()
	{
		((SDMSExitStateProfileGeneric) object).print();
	}
}
