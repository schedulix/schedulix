...
public class SDMSResourceVariableTableGeneric extends SDMSTable
{
	...
	throws SDMSException
	{
		...
		idx_pdId_rId = new SDMSIndex(env, SDMSIndex.UNIQUE, isVersioned, table, "pdId_rId");
	}
	...
	throws SDMSException
	{
		...
		try {
			...
			p = (SDMSResourceVariable)(o.toProxy(env));
			p.current = true;
	...
	throws SDMSException
	{
		...
		try {
			...
			pdId = Long.valueOf (r.getLong(2));
			rId = Long.valueOf (r.getLong(3));
			value = r.getString(4);
			...
			throw new FatalException(new SDMSMessage(env, "01110182045", "ResourceVariable: $1 $2", Integer.valueOf(sqle.getErrorCode()), sqle.getMessage()));
		}
	...
	throws SDMSException
	{
		String out = "";
		boolean ok;
		ok =  idx_pdId.check(((SDMSResourceVariableGeneric) o).pdId, o);
		out = out + "idx_pdId: " + (ok ? "ok" : "missing") + "\n";
		ok =  idx_rId.check(((SDMSResourceVariableGeneric) o).rId, o);
		out = out + "idx_rId: " + (ok ? "ok" : "missing") + "\n";
		SDMSKey k;
		k = new SDMSKey();
		k.add(((SDMSResourceVariableGeneric) o).pdId);
		k.add(((SDMSResourceVariableGeneric) o).rId);
		ok =  idx_pdId_rId.check(k, o);
		out = out + "idx_pdId_rId: " + (ok ? "ok" : "missing") + "\n";
		return out;
	}
	...
	throws SDMSException
	{
		idx_pdId.put(env, ((SDMSResourceVariableGeneric) o).pdId, o, ((1 & indexMember) != 0));
		idx_rId.put(env, ((SDMSResourceVariableGeneric) o).rId, o, ((2 & indexMember) != 0));
		SDMSKey k;
		k = new SDMSKey();
		k.add(((SDMSResourceVariableGeneric) o).pdId);
		k.add(((SDMSResourceVariableGeneric) o).rId);
		idx_pdId_rId.put(env, k, o, ((4 & indexMember) != 0));
	}
	...
	public static SDMSResourceVariable getObjectForUpdate(SystemEnvironment env, Long id)
	throws SDMSException
	{
		return (SDMSResourceVariable) table.getForUpdate(env, id);
	}
	...
	public static SDMSResourceVariable idx_pdId_rId_getUniqueForUpdate(SystemEnvironment env, Object key)
	throws SDMSException
	{
		return (SDMSResourceVariable)  SDMSResourceVariableTableGeneric.idx_pdId_rId.getUniqueForUpdate(env, key);
	}
