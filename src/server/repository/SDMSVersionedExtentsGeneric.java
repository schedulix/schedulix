	...
	implements Cloneable
{
	...
	throws SDMSException
	{
		...
		if (o.versions.o_v == null || o.subTxId != env.tx.subTxId) o = (SDMSVersionedExtentsGeneric) change(env);
	...
	throws SDMSException
	{
		...
		try {
			...
			throw new SDMSSQLException(new SDMSMessage(env, "01110181954", "VersionedExtents: $1 $2", new Integer(sqle.getErrorCode()), sqle.getMessage()));
		}
	}
	...
	throws SDMSException
	{
		...
		try {
			...
			throw new SDMSSQLException(new SDMSMessage(env, "01110181956", "VersionedExtents: $1 $2", new Integer(sqle.getErrorCode()), sqle.getMessage()));
		}
	}
