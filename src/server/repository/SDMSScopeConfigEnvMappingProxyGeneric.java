...
public class SDMSScopeConfigEnvMappingProxyGeneric extends SDMSProxy
{

	public final static String __version = "SDMSScopeConfigEnvMappingProxyGeneric $Revision: 2.2 $ / @(#) $Id: generate.py,v 2.42.2.7 2013/04/17 12:40:29 ronald Exp $";
	...
	{
		checkRead(env);
		return (((SDMSScopeConfigEnvMappingGeneric)(object)).getKey (env));
	}
	...
	{
		checkRead(env);
		return (((SDMSScopeConfigEnvMappingGeneric)(object)).getValue (env));
	}
	...
	{
		checkRead(env);
		return (((SDMSScopeConfigEnvMappingGeneric)(object)).getSId (env));
	}
	...
	throws SDMSException
	{
		...
		touchMaster(env);
		((SDMSScopeConfigEnvMappingGeneric)(object)).setSId (env, p_sId);
		return ;
	}
	...
	{
		checkRead(env);
		return (((SDMSScopeConfigEnvMappingGeneric)(object)).getCreatorUId (env));
	}
	...
	throws SDMSException
	{
		...
		touchMaster(env);
		((SDMSScopeConfigEnvMappingGeneric)(object)).setCreatorUId (env, p_creatorUId);
		return ;
	}
	...
	{
		checkRead(env);
		return (((SDMSScopeConfigEnvMappingGeneric)(object)).getCreateTs (env));
	}
	...
	throws SDMSException
	{
		...
		touchMaster(env);
		((SDMSScopeConfigEnvMappingGeneric)(object)).setCreateTs (env, p_createTs);
		return ;
	}
	...
	{
		checkRead(env);
		return (((SDMSScopeConfigEnvMappingGeneric)(object)).getChangerUId (env));
	}
	...
	throws SDMSException
	{
		...
		touchMaster(env);
		((SDMSScopeConfigEnvMappingGeneric)(object)).setChangerUId (env, p_changerUId);
		return ;
	}
	protected SDMSScopeConfigEnvMapping setChangerUIdNoCheck (SystemEnvironment env, Long p_changerUId)
	throws SDMSException
	{
		checkWrite(env);
		touchMaster(env);
		((SDMSScopeConfigEnvMappingGeneric)(object)).setChangerUId (env, p_changerUId);
		return (SDMSScopeConfigEnvMapping)this;
	}
	public Long getChangeTs (SystemEnvironment env)
	throws SDMSException
	{
		checkRead(env);
		return (((SDMSScopeConfigEnvMappingGeneric)(object)).getChangeTs (env));
	}
	...
	throws SDMSException
	{
		...
		touchMaster(env);
		((SDMSScopeConfigEnvMappingGeneric)(object)).setChangeTs (env, p_changeTs);
		return ;
	}
	protected SDMSScopeConfigEnvMapping setChangeTsNoCheck (SystemEnvironment env, Long p_changeTs)
	throws SDMSException
	{
		checkWrite(env);
		touchMaster(env);
	...
	public SDMSScopeConfigEnvMapping set_SIdKey (SystemEnvironment env, Long p_sId, String p_key)
	throws SDMSException
	{
		checkRead(env);
		if(!checkPrivileges(env, SDMSPrivilege.EDIT))
		...
		touchMaster(env);
		((SDMSScopeConfigEnvMappingGeneric)(object)).set_SIdKey (env, p_sId, p_key);
		return (SDMSScopeConfigEnvMapping)this;
	}
	...
	{
		SDMSMessage m;
		m = new SDMSMessage(sysEnv, errno, "Insufficient privileges accessing ScopeConfigEnvMapping $1", getId(sysEnv));
		return m;
	}
	...
	public void print()
	{
		((SDMSScopeConfigEnvMappingGeneric) object).print();
	}
}
