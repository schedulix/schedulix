...
public class SDMSExitStateMappingProfileProxyGeneric extends SDMSProxy
{
	...
	protected SDMSExitStateMappingProfileProxyGeneric(SDMSObject p_object)
	{
		super(p_object);
	}

	protected static SDMSExitStateMappingProfile getProxy (SystemEnvironment sysEnv, SDMSObject p_object)
	{
		int i = SDMSExitStateMappingProfileTable.table.tableIndex;
		SDMSProxy p = SDMSRepository.getProxy(i);
		if (p == null)
			p = new SDMSExitStateMappingProfile (p_object);
		else {
			p.initProxy(p_object);
		}
		sysEnv.tx.addUsedProxy(i, p);
		return (SDMSExitStateMappingProfile)p;
	}
	...
	{
		checkRead(env);
		return (((SDMSExitStateMappingProfileGeneric)(object)).getName (env));
	}
	...
	throws SDMSException
	{
		...
		((SDMSExitStateMappingProfileGeneric)(object)).setName (env, p_name);
		return ;
	}
	...
	{
		checkRead(env);
		return (((SDMSExitStateMappingProfileGeneric)(object)).getCreatorUId (env));
	}
	...
	throws SDMSException
	{
		...
		((SDMSExitStateMappingProfileGeneric)(object)).setCreatorUId (env, p_creatorUId);
		return ;
	}
	...
	{
		checkRead(env);
		return (((SDMSExitStateMappingProfileGeneric)(object)).getCreateTs (env));
	}
	...
	throws SDMSException
	{
		...
		((SDMSExitStateMappingProfileGeneric)(object)).setCreateTs (env, p_createTs);
		return ;
	}
	...
	{
		checkRead(env);
		return (((SDMSExitStateMappingProfileGeneric)(object)).getChangerUId (env));
	}
	...
	throws SDMSException
	{
		...
		((SDMSExitStateMappingProfileGeneric)(object)).setChangerUId (env, p_changerUId);
		return ;
	}
	protected SDMSExitStateMappingProfile setChangerUIdNoCheck (SystemEnvironment env, Long p_changerUId)
	throws SDMSException
	{
		checkWrite(env);
		((SDMSExitStateMappingProfileGeneric)(object)).setChangerUId (env, p_changerUId);
		return (SDMSExitStateMappingProfile)this;
	}
	public Long getChangeTs (SystemEnvironment env)
	throws SDMSException
	{
		checkRead(env);
		return (((SDMSExitStateMappingProfileGeneric)(object)).getChangeTs (env));
	}
	...
	throws SDMSException
	{
		...
		((SDMSExitStateMappingProfileGeneric)(object)).setChangeTs (env, p_changeTs);
		return ;
	}
	protected SDMSExitStateMappingProfile setChangeTsNoCheck (SystemEnvironment env, Long p_changeTs)
	throws SDMSException
	{
		checkWrite(env);
		((SDMSExitStateMappingProfileGeneric)(object)).setChangeTs (env, p_changeTs);
	...
	{
		SDMSMessage m;
		m = new SDMSMessage(sysEnv, errno, "Insufficient privileges accessing Exit State Mapping $1", getName(sysEnv));
		return m;
	}
	...
	public void print()
	{
		((SDMSExitStateMappingProfileGeneric) object).print();
	}
}
