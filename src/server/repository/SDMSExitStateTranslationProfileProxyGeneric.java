...
public class SDMSExitStateTranslationProfileProxyGeneric extends SDMSProxy
{
	...
	protected SDMSExitStateTranslationProfileProxyGeneric(SDMSObject p_object)
	{
		super(p_object);
	}

	protected static SDMSExitStateTranslationProfile getProxy (SystemEnvironment sysEnv, SDMSObject p_object)
	{
		int i = SDMSExitStateTranslationProfileTable.table.tableIndex;
		SDMSProxy p = SDMSRepository.getProxy(i);
		if (p == null)
			p = new SDMSExitStateTranslationProfile (p_object);
		else {
			p.initProxy(p_object);
		}
		sysEnv.tx.addUsedProxy(i, p);
		return (SDMSExitStateTranslationProfile)p;
	}
	...
	{
		checkRead(env);
		return (((SDMSExitStateTranslationProfileGeneric)(object)).getName (env));
	}
	...
	throws SDMSException
	{
		...
		((SDMSExitStateTranslationProfileGeneric)(object)).setName (env, p_name);
		return ;
	}
	...
	{
		checkRead(env);
		return (((SDMSExitStateTranslationProfileGeneric)(object)).getCreatorUId (env));
	}
	...
	throws SDMSException
	{
		...
		((SDMSExitStateTranslationProfileGeneric)(object)).setCreatorUId (env, p_creatorUId);
		return ;
	}
	...
	{
		checkRead(env);
		return (((SDMSExitStateTranslationProfileGeneric)(object)).getCreateTs (env));
	}
	...
	throws SDMSException
	{
		...
		((SDMSExitStateTranslationProfileGeneric)(object)).setCreateTs (env, p_createTs);
		return ;
	}
	...
	{
		checkRead(env);
		return (((SDMSExitStateTranslationProfileGeneric)(object)).getChangerUId (env));
	}
	...
	throws SDMSException
	{
		...
		((SDMSExitStateTranslationProfileGeneric)(object)).setChangerUId (env, p_changerUId);
		return ;
	}
	protected SDMSExitStateTranslationProfile setChangerUIdNoCheck (SystemEnvironment env, Long p_changerUId)
	throws SDMSException
	{
		checkWrite(env);
		((SDMSExitStateTranslationProfileGeneric)(object)).setChangerUId (env, p_changerUId);
	...
	{
		checkRead(env);
		return (((SDMSExitStateTranslationProfileGeneric)(object)).getChangeTs (env));
	}
	...
	protected SDMSExitStateTranslationProfile setChangeTsNoCheck (SystemEnvironment env, Long p_changeTs)
	throws SDMSException
	{
		checkWrite(env);
		((SDMSExitStateTranslationProfileGeneric)(object)).setChangeTs (env, p_changeTs);
	...
	{
		SDMSMessage m;
		m = new SDMSMessage(sysEnv, errno, "Insufficient privileges accessing Exit State Translation $1", getName(sysEnv));
		return m;
	}
	...
	public void print()
	{
		((SDMSExitStateTranslationProfileGeneric) object).print();
	}
}
