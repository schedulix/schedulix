...
public class SDMSResourceStateProfileTableGeneric extends SDMSTable
{
	...
	throws SDMSException
	{
		...
		try {
			...
			p = (SDMSResourceStateProfile)(o.toProxy(env));
			p.current = true;
	...
	throws SDMSException
	{
		...
		try {
			...
			name = r.getString(2);
			initialRsdId = Long.valueOf (r.getLong(3));
			...
			throw new FatalException(new SDMSMessage(env, "01110182045", "ResourceStateProfile: $1 $2", Integer.valueOf(sqle.getErrorCode()), sqle.getMessage()));
		}
	...
	public static SDMSResourceStateProfile getObjectForUpdate(SystemEnvironment env, Long id)
	throws SDMSException
	{
		return (SDMSResourceStateProfile) table.getForUpdate(env, id);
	}
	...
	public static SDMSResourceStateProfile idx_name_getUniqueForUpdate(SystemEnvironment env, Object key)
	throws SDMSException
	{
		return (SDMSResourceStateProfile) SDMSResourceStateProfileTableGeneric.idx_name.getUniqueForUpdate(env, key);
	}
