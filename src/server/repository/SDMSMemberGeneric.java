	...
	implements Cloneable
{
	...
	throws SDMSException
	{
		...
		try {
			...
			myInsert.setLong (2, gId.longValue());
			myInsert.setLong (3, uId.longValue());
			...
			throw new SDMSSQLException(new SDMSMessage(env, "01110181954", "Member: $1 $2", Integer.valueOf(sqle.getErrorCode()), sqle.getMessage()));
		}
	}
	...
	throws SDMSException
	{
		...
		try {
			...
			throw new SDMSSQLException(new SDMSMessage(env, "01110182002", "Member: $1 $2", Integer.valueOf(sqle.getErrorCode()), sqle.getMessage()));
		}
	}
	...
	throws SDMSException
	{
		...
		try {
			...
			myUpdate.setLong (1, gId.longValue());
			myUpdate.setLong (2, uId.longValue());
			...
			throw new SDMSSQLException(new SDMSMessage(env, "01110182006", "Member: $1 $2", Integer.valueOf(sqle.getErrorCode()), sqle.getMessage()));
		}
	}
