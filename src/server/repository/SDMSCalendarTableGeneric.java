...
public class SDMSCalendarTableGeneric extends SDMSTable
{
	...
	throws SDMSException
	{
		...
		try {
			...
			scevId = Long.valueOf (r.getLong(2));
			starttime = Long.valueOf (r.getLong(3));
			...
			throw new FatalException(new SDMSMessage(env, "01110182045", "Calendar: $1 $2", Integer.valueOf(sqle.getErrorCode()), sqle.getMessage()));
		}
