...
public class SDMSScopeConfigEnvMappingTableGeneric extends SDMSTable
{
	...
	throws SDMSException
	{
		...
		try {
			...
			p = (SDMSScopeConfigEnvMapping)(o.toProxy(env));
			p.current = true;
	...
	throws SDMSException
	{
		String out = "";
		boolean ok;
		ok =  idx_sId.check(((SDMSScopeConfigEnvMappingGeneric) o).sId, o);
	...
	throws SDMSException
	{
		idx_sId.put(env, ((SDMSScopeConfigEnvMappingGeneric) o).sId, o, ((1 & indexMember) != 0));
		SDMSKey k;
		k = new SDMSKey();
		k.add(((SDMSScopeConfigEnvMappingGeneric) o).sId);
		k.add(((SDMSScopeConfigEnvMappingGeneric) o).key);
	...
	public static SDMSScopeConfigEnvMapping getObjectForUpdate(SystemEnvironment env, Long id)
	throws SDMSException
	{
		return (SDMSScopeConfigEnvMapping) table.getForUpdate(env, id);
	}
	...
	public static SDMSScopeConfigEnvMapping idx_scopeId_key_getUniqueForUpdate(SystemEnvironment env, Object key)
	throws SDMSException
	{
		return (SDMSScopeConfigEnvMapping)  SDMSScopeConfigEnvMappingTableGeneric.idx_scopeId_key.getUniqueForUpdate(env, key);
	}
