...
public class SDMSDependencyStateTableGeneric extends SDMSTable
{
	...
	public final static String __version = "SDMSDependencyStateTableGeneric $Revision: 2.4 $ / @(#) $Id: generate.py,v 2.42.2.7 2013/04/17 12:40:29 ronald Exp $";
	...
	throws SDMSException
	{
		...
		idx_ddId_esdId = new SDMSIndex(env, SDMSIndex.UNIQUE, isVersioned);
	}
	...
	throws SDMSException
	{
		...
		try {
			...
			p = (SDMSDependencyState)(o.toProxy());
			p.current = true;
