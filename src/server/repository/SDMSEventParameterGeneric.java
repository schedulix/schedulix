...
public class SDMSEventParameterGeneric extends SDMSObject
	implements Cloneable
{

	public final static String __version = "SDMSEventParameterGeneric $Revision: 2.2 $ / @(#) $Id: generate.py,v 2.42.2.7 2013/04/17 12:40:29 ronald Exp $";
	...
	public static String tableName = SDMSEventParameterTableGeneric.tableName;
	...
	public SDMSEventParameterGeneric(
	...
	{
		super(env, SDMSEventParameterTableGeneric.table);
		if (p_key != null && p_key.length() > 64) {
			throw new CommonErrorException (
			        new SDMSMessage(env, "01112141528",
			                        "(EventParameter) Length of $1 exceeds maximum length $2", "key", "64")
			);
		}
		key = p_key;
		if (p_value != null && p_value.length() > 256) {
			throw new CommonErrorException (
			        new SDMSMessage(env, "01112141528",
			                        "(EventParameter) Length of $1 exceeds maximum length $2", "value", "256")
			);
		}
		value = p_value;
		evtId = p_evtId;
	...
	public	SDMSEventParameterGeneric setKey (SystemEnvironment env, String p_key)
	throws SDMSException
	{
		if(key.equals(p_key)) return this;
		SDMSEventParameterGeneric o;
		...
		try {
			...
			o = (SDMSEventParameterGeneric) change(env);
			if (p_key != null && p_key.length() > 64) {
				throw new CommonErrorException (
	...
	public	SDMSEventParameterGeneric setValue (SystemEnvironment env, String p_value)
	throws SDMSException
	{
	...
	public	SDMSEventParameterGeneric setEvtId (SystemEnvironment env, Long p_evtId)
	throws SDMSException
	{
	...
	SDMSEventParameterGeneric setCreatorUId (SystemEnvironment env, Long p_creatorUId)
	throws SDMSException
	{
	...
	SDMSEventParameterGeneric setCreateTs (SystemEnvironment env, Long p_createTs)
	throws SDMSException
	{
	...
	public	SDMSEventParameterGeneric setChangerUId (SystemEnvironment env, Long p_changerUId)
	throws SDMSException
	{
		SDMSEventParameterGeneric o;
		env.tx.beginSubTransaction(env);
	...
	SDMSEventParameterGeneric setChangeTs (SystemEnvironment env, Long p_changeTs)
	throws SDMSException
	{
	...
	public SDMSEventParameterGeneric set_EvtIdKey (SystemEnvironment env, Long p_evtId, String p_key)
	throws SDMSException
	{
		SDMSEventParameterGeneric o;
		...
		try {
			if (versions.id.longValue() < SystemEnvironment.SYSTEM_OBJECTS_BOUNDARY) {
				throw new CommonErrorException(
				        new SDMSMessage (env, "02112141637", "(EventParameter) Change of system object not allowed")
				);
			}
			o = (SDMSEventParameterGeneric) change(env);
			o.evtId = p_evtId;
			if (p_key != null && p_key.length() > 64) {
				throw new CommonErrorException (
				        new SDMSMessage(env, "01201290026",
				                        "(EventParameter) Length of $1 exceeds maximum length $2", "changeTs", "64")
				);
			}
			o.key = p_key;
			o.changerUId = env.cEnv.euid();
	...
	throws SDMSException
	{
		...
		if(pInsert == null) {
			try {
				...
				throw new FatalException(new SDMSMessage(env, "01110181952", "EventParameter: $1\n$2", stmt, sqle.toString()));
			}
		}
		...
		try {
			...
			throw new FatalException(new SDMSMessage(env, "01110181954", "EventParameter: $1 $2", new Integer(sqle.getErrorCode()), sqle.getMessage()));
		}
	}
	...
	throws SDMSException
	{
		...
		try {
			...
			throw new FatalException(new SDMSMessage(env, "01110182002", "EventParameter: $1 $2", new Integer(sqle.getErrorCode()), sqle.getMessage()));
		}
	}
	...
	throws SDMSException
	{
		...
		if(pUpdate == null) {
			try {
				...
				throw new FatalException(new SDMSMessage(env, "01110182005", "EventParameter: $1\n$2", stmt, sqle.toString()));
			}
		}
		try {
			...
			throw new FatalException(new SDMSMessage(env, "01110182006", "EventParameter: $1 $2", new Integer(sqle.getErrorCode()), sqle.getMessage()));
		}
	}

	public void print()
	{
		SDMSThread.doTrace(null, "Type : EventParameter", SDMSThread.SEVERITY_MESSAGE);
