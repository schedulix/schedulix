...
public class SDMSNiceProfileTableGeneric extends SDMSTable
{
	...
	throws SDMSException
	{
		...
		SDMSNiceProfileTableGeneric.table = (SDMSNiceProfileTable) this;
		isVersioned = false;
		idx_name = new SDMSIndex(env, SDMSIndex.UNIQUE, isVersioned, table, "name");
	}
	public SDMSNiceProfile create(SystemEnvironment env
	                              ,String p_name
	                              ,Boolean p_isActive
	                              ,Long p_activeTs
	                             )
	throws SDMSException
	{
		...
		SDMSNiceProfileGeneric o = new SDMSNiceProfileGeneric(env
		                , p_name
		                , p_isActive
		                , p_activeTs
		                , p_creatorUId
	...
	protected boolean checkCreatePrivs(SystemEnvironment env, SDMSNiceProfile p)
	throws SDMSException
	{
	...
	throws SDMSException
	{
		...
		try {
			...
			name = r.getString(2);
			isActive = Boolean.valueOf ((r.getInt(3) == 0 ? false : true));
			activeTs = Long.valueOf (r.getLong(4));
			if (r.wasNull()) activeTs = null;
			...
			throw new FatalException(new SDMSMessage(env, "01110182045", "NiceProfile: $1 $2", Integer.valueOf(sqle.getErrorCode()), sqle.getMessage()));
		}
		if(validTo < env.lowestActiveVersion) return null;
		return new SDMSNiceProfileGeneric(id,
		                                  name,
		                                  isActive,
		                                  activeTs,
		                                  creatorUId,
	...
	throws SDMSException
	{
		String out = "";
		boolean ok;
		ok =  idx_name.check(((SDMSNiceProfileGeneric) o).name, o);
	...
	throws SDMSException
	{
		idx_name.put(env, ((SDMSNiceProfileGeneric) o).name, o, ((1 & indexMember) != 0));
	}

	protected  void unIndex(SystemEnvironment env, SDMSObject o)
	throws SDMSException
	{
		idx_name.remove(env, ((SDMSNiceProfileGeneric) o).name, o);
	}

	public static SDMSNiceProfile getObject(SystemEnvironment env, Long id)
	throws SDMSException
	{
	...
	throws SDMSException
	{
		return (SDMSNiceProfile) table.get(env, id, version);
	}

	public static SDMSNiceProfile idx_name_getUnique(SystemEnvironment env, Object key)
	throws SDMSException
	{
	...
	throws SDMSException
	{
		return (SDMSNiceProfile) SDMSNiceProfileTableGeneric.idx_name.getUnique(env, key, version);
	}
