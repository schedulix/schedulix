...
public class SDMSFootprintTableGeneric extends SDMSTable
{
	...
	throws SDMSException
	{
		...
		try {
			...
			throw new FatalException(new SDMSMessage(env, "01110182045", "Footprint: $1 $2", Integer.valueOf(sqle.getErrorCode()), sqle.getMessage()));
		}
	...
	throws SDMSException
	{
		String out = "";
		boolean ok;
		ok =  idx_name.check(((SDMSFootprintGeneric) o).name, o);
	...
	throws SDMSException
	{
		idx_name.put(env, ((SDMSFootprintGeneric) o).name, o, ((1 & indexMember) != 0));
	}
