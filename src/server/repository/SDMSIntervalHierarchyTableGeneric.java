...
public class SDMSIntervalHierarchyTableGeneric extends SDMSTable
{
	...
	public final static String __version = "SDMSIntervalHierarchyTableGeneric $Revision: 2.1 $ / @(#) $Id: generate.py,v 2.42.2.7 2013/04/17 12:40:29 ronald Exp $";
	...
	throws SDMSException
	{
		idx_childId.put(env, ((SDMSIntervalHierarchyGeneric) o).childId, o);
		idx_parentId.put(env, ((SDMSIntervalHierarchyGeneric) o).parentId, o);
	}
