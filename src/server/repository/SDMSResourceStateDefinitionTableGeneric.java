...
public class SDMSResourceStateDefinitionTableGeneric extends SDMSTable
{
	...
	public final static String __version = "SDMSResourceStateDefinitionTableGeneric $Revision: 2.3 $ / @(#) $Id: generate.py,v 2.42.2.7 2013/04/17 12:40:29 ronald Exp $";
	...
	throws SDMSException
	{
		...
		try {
			...
			p = (SDMSResourceStateDefinition)(o.toProxy());
			p.current = true;
	...
	throws SDMSException
	{
		idx_name.put(env, ((SDMSResourceStateDefinitionGeneric) o).name, o);
	}
