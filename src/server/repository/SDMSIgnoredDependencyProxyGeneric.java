...
public class SDMSIgnoredDependencyProxyGeneric extends SDMSProxy
{

	public final static long privilegeMask = SDMSPrivilege.EDIT|SDMSPrivilege.CREATE|SDMSPrivilege.VIEW|SDMSPrivilege.DROP;

	static final public int ddName_size = 64;

	private static SDMSTable masterTables[] = null;

	protected SDMSIgnoredDependencyProxyGeneric(SDMSObject p_object)
	{
		super(p_object);
	}

	protected static SDMSIgnoredDependency getProxy (SystemEnvironment sysEnv, SDMSObject p_object)
	{
		int i = SDMSIgnoredDependencyTable.table.tableIndex;
		SDMSProxy p = SDMSRepository.getProxy(i);
		if (p == null)
			p = new SDMSIgnoredDependency (p_object);
		else {
			p.initProxy(p_object);
		}
		sysEnv.tx.addUsedProxy(i, p);
		return (SDMSIgnoredDependency)p;
	}
	...
	{
		checkRead(env);
		return (((SDMSIgnoredDependencyGeneric)(object)).getShId (env));
	}
	...
	throws SDMSException
	{
		...
		touchMaster(env);
		((SDMSIgnoredDependencyGeneric)(object)).setShId (env, p_shId);
		return ;
	}
	...
	{
		checkRead(env);
		return (((SDMSIgnoredDependencyGeneric)(object)).getDdName (env));
	}
	...
	{
		checkRead(env);
		return (((SDMSIgnoredDependencyGeneric)(object)).getCreatorUId (env));
	}
	...
	throws SDMSException
	{
		...
		touchMaster(env);
		((SDMSIgnoredDependencyGeneric)(object)).setCreatorUId (env, p_creatorUId);
		return ;
	}
	...
	{
		checkRead(env);
		return (((SDMSIgnoredDependencyGeneric)(object)).getCreateTs (env));
	}
	...
	throws SDMSException
	{
		...
		touchMaster(env);
		((SDMSIgnoredDependencyGeneric)(object)).setCreateTs (env, p_createTs);
		return ;
	}
	...
	{
		checkRead(env);
		return (((SDMSIgnoredDependencyGeneric)(object)).getChangerUId (env));
	}
	...
	throws SDMSException
	{
		...
		touchMaster(env);
		((SDMSIgnoredDependencyGeneric)(object)).setChangerUId (env, p_changerUId);
		return ;
	}
	protected SDMSIgnoredDependency setChangerUIdNoCheck (SystemEnvironment env, Long p_changerUId)
	throws SDMSException
	{
		checkWrite(env);
		touchMaster(env);
		((SDMSIgnoredDependencyGeneric)(object)).setChangerUId (env, p_changerUId);
		return (SDMSIgnoredDependency)this;
	}
	public Long getChangeTs (SystemEnvironment env)
	throws SDMSException
	{
		checkRead(env);
		return (((SDMSIgnoredDependencyGeneric)(object)).getChangeTs (env));
	}
	...
	throws SDMSException
	{
		...
		touchMaster(env);
		((SDMSIgnoredDependencyGeneric)(object)).setChangeTs (env, p_changeTs);
		return ;
	}
	protected SDMSIgnoredDependency setChangeTsNoCheck (SystemEnvironment env, Long p_changeTs)
	throws SDMSException
	{
		checkWrite(env);
		touchMaster(env);
	...
	public SDMSIgnoredDependency set_ShIdDdName (SystemEnvironment env, Long p_shId, String p_ddName)
	throws SDMSException
	{
		checkRead(env);
		if(!checkPrivileges(env, SDMSPrivilege.EDIT))
		...
		touchMaster(env);
		((SDMSIgnoredDependencyGeneric)(object)).set_ShIdDdName (env, p_shId, p_ddName);
		return (SDMSIgnoredDependency)this;
	}
	...
	throws SDMSException
	{
		...
		s.add(getShId(sysEnv));

		s.add(getDdName(sysEnv));
	...
	{
		SDMSMessage m;
		m = new SDMSMessage(sysEnv, errno, "Insufficient privileges accessing IgnoredDependency $1", getId(sysEnv));
		return m;
	}
	...
	throws SDMSException
	{
		...
		t = SystemEnvironment.repository.getTable(env, SDMSSchedulingHierarchyTable.tableName);
		try {
			SDMSProxy p = t.get(env, getShId(env));
			p.touch(env);
		} catch (NotFoundException nfe) {
		}
	}
	...
	public void print()
	{
		((SDMSIgnoredDependencyGeneric) object).print();
	}
}
