...
public class SDMSGroupTableGeneric extends SDMSTable
{
	...
	throws SDMSException
	{
		...
		try {
			...
			name = r.getString(2);
			deleteVersion = Long.valueOf (r.getLong(3));
			...
			throw new FatalException(new SDMSMessage(env, "01110182045", "Group: $1 $2", Integer.valueOf(sqle.getErrorCode()), sqle.getMessage()));
		}
