...
public class SDMSEventParameterTableGeneric extends SDMSTable
{
	...
	public final static String __version = "SDMSEventParameterTableGeneric $Revision: 2.2 $ / @(#) $Id: generate.py,v 2.42.2.7 2013/04/17 12:40:29 ronald Exp $";
	...
	throws SDMSException
	{
		...
		idx_eventId_key = new SDMSIndex(env, SDMSIndex.UNIQUE, isVersioned);
	}
	...
	throws SDMSException
	{
		...
		try {
			...
			p = (SDMSEventParameter)(o.toProxy());
			p.current = true;
	...
	throws SDMSException
	{
		idx_evtId.put(env, ((SDMSEventParameterGeneric) o).evtId, o);
		SDMSKey k;
		k = new SDMSKey();
		k.add(((SDMSEventParameterGeneric) o).evtId);
		k.add(((SDMSEventParameterGeneric) o).key);
		idx_eventId_key.put(env, k, o);
	}
