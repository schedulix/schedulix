...
public class SDMSNiceProfileProxyGeneric extends SDMSProxy
{
	...
	protected SDMSNiceProfileProxyGeneric(SDMSObject p_object)
	{
		super(p_object);
	}

	protected static SDMSNiceProfile getProxy (SystemEnvironment sysEnv, SDMSObject p_object)
	{
		int i = SDMSNiceProfileTable.table.tableIndex;
		SDMSProxy p = SDMSRepository.getProxy(i);
		if (p == null)
			p = new SDMSNiceProfile (p_object);
		else {
			p.initProxy(p_object);
		}
		sysEnv.tx.addUsedProxy(i, p);
		return (SDMSNiceProfile)p;
	}
	...
	{
		checkRead(env);
		return (((SDMSNiceProfileGeneric)(object)).getName (env));
	}
	...
	throws SDMSException
	{
		...
		((SDMSNiceProfileGeneric)(object)).setName (env, p_name);
		return ;
	}
	...
	{
		checkRead(env);
		return (((SDMSNiceProfileGeneric)(object)).getIsActive (env));
	}
	...
	throws SDMSException
	{
		...
		((SDMSNiceProfileGeneric)(object)).setIsActive (env, p_isActive);
		return ;
	}
	...
	{
		checkRead(env);
		return (((SDMSNiceProfileGeneric)(object)).getActiveTs (env));
	}

	public void setActiveTs (SystemEnvironment env, Long p_activeTs)
	throws SDMSException
	{
		checkWrite(env);
		if(!checkPrivileges(env, SDMSPrivilege.EDIT))
		...
		((SDMSNiceProfileGeneric)(object)).setActiveTs (env, p_activeTs);
		return ;
	}
	...
	{
		checkRead(env);
		return (((SDMSNiceProfileGeneric)(object)).getCreatorUId (env));
	}
	...
	throws SDMSException
	{
		...
		((SDMSNiceProfileGeneric)(object)).setCreatorUId (env, p_creatorUId);
		return ;
	}
	...
	{
		checkRead(env);
		return (((SDMSNiceProfileGeneric)(object)).getCreateTs (env));
	}
	...
	throws SDMSException
	{
		...
		((SDMSNiceProfileGeneric)(object)).setCreateTs (env, p_createTs);
		return ;
	}
	...
	{
		checkRead(env);
		return (((SDMSNiceProfileGeneric)(object)).getChangerUId (env));
	}
	...
	throws SDMSException
	{
		...
		((SDMSNiceProfileGeneric)(object)).setChangerUId (env, p_changerUId);
		return ;
	}
	protected SDMSNiceProfile setChangerUIdNoCheck (SystemEnvironment env, Long p_changerUId)
	throws SDMSException
	{
		checkWrite(env);
		((SDMSNiceProfileGeneric)(object)).setChangerUId (env, p_changerUId);
		return (SDMSNiceProfile)this;
	}
	public Long getChangeTs (SystemEnvironment env)
	throws SDMSException
	{
		checkRead(env);
		return (((SDMSNiceProfileGeneric)(object)).getChangeTs (env));
	}
	...
	throws SDMSException
	{
		...
		((SDMSNiceProfileGeneric)(object)).setChangeTs (env, p_changeTs);
		return ;
	}
	protected SDMSNiceProfile setChangeTsNoCheck (SystemEnvironment env, Long p_changeTs)
	throws SDMSException
	{
		checkWrite(env);
		((SDMSNiceProfileGeneric)(object)).setChangeTs (env, p_changeTs);
	...
	{
		SDMSMessage m;
		m = new SDMSMessage(sysEnv, errno, "Insufficient privileges accessing Nice Profile $1", getName(sysEnv));
		return m;
	}
	...
	public void print()
	{
		((SDMSNiceProfileGeneric) object).print();
	}
}
