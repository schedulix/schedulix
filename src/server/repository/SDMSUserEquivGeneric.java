	...
	implements Cloneable
{
	...
	throws SDMSException
	{
		...
		try {
			...
			throw new SDMSSQLException(new SDMSMessage(env, "01110181954", "UserEquiv: $1 $2", new Integer(sqle.getErrorCode()), sqle.getMessage()));
		}
	}
	...
	throws SDMSException
	{
		...
		try {
			...
			throw new SDMSSQLException(new SDMSMessage(env, "01110182002", "UserEquiv: $1 $2", new Integer(sqle.getErrorCode()), sqle.getMessage()));
		}
	}
	...
	throws SDMSException
	{
		...
		try {
			...
			throw new SDMSSQLException(new SDMSMessage(env, "01110182006", "UserEquiv: $1 $2", new Integer(sqle.getErrorCode()), sqle.getMessage()));
		}
	}
