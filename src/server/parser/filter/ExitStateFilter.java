...
public class ExitStateFilter extends Filter
{

	public final static String __version = "@(#) $Id: ExitStateFilter.java,v 2.0.20.1 2013/03/14 10:25:13 ronald Exp $";

	Vector exitStates;
	HashSet esdIds = null;

	public ExitStateFilter(SystemEnvironment sysEnv, Vector v)
	{
		super();
		exitStates = v;
	}
