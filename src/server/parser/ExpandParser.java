...
public class ExpandParser
{
	...
	public static final int T_OBJECT_MONITOR  = 113;
	public static final int T_POOL            = 114;
	public static final int T_RESOURCE        = 115;
	public static final int T_RESOURCE_TMPL   = 116;
	public static final int T_RSD             = 117;
	public static final int T_RSM             = 118;
	public static final int T_RSP             = 119;
	public static final int T_SCHEDULE        = 120;
	public static final int T_SCHEDULED_EVENT = 121;
	public static final int T_SCOPE           = 122;
	public static final int T_TRIGGER         = 123;
	public static final int T_USER            = 124;
	public static final int T_WATCH_TYPE      = 125;
